        ...
        <div className="bg-gray-50 text-gray-700">
            ...
            <section className="relative bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 text-white">
                ...
                <div className="absolute inset-0 opacity-20">
                    <Image
                        src="/careers-hero.jpg" // Replace with your image path
                        alt="Careers Hero"
                        layout="fill"
                        objectFit="cover"
                    />
            ...
            <section className="container mx-auto py-20 px-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    <div className="bg-white shadow-md rounded-lg p-8 text-center">
                        <h3 className="text-3xl font-bold text-pink-500">Innovation</h3>
                        <p className="mt-4 text-lg">We encourage new ideas and continuous learning to keep improving.</p>
                    </div>
                    <div className="bg-white shadow-md rounded-lg p-8 text-center">
                        <h3 className="text-3xl font-bold text-pink-500">Teamwork</h3>
                        <p className="mt-4 text-lg">Collaboration is key to our success. Together, we achieve more.</p>
                    </div>
                    <div className="bg-white shadow-md rounded-lg p-8 text-center">
                        <h3 className="text-3xl font-bold text-pink-500">Growth</h3>
                        <p className="mt-4 text-lg">We believe in fostering personal and professional growth within our team.</p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        {jobListings.map((job, index) => (
                            <div key={index} className="bg-white shadow-md rounded-lg p-8 text-center transform transition hover:scale-105">
                                <h3 className="text-3xl font-bold text-pink-500">{job.title}</h3>
                                <p className="mt-4 text-lg text-gray-600">{job.location}</p>
                                <p className="mt-4 text-lg">{job.description}</p>
                                <a href="#" className="text-pink-500 mt-4 inline-block text-lg font-semibold">
                                    Apply Now
                                </a>
                            </div>
                        ))}
            ...
            <section className="bg-gradient-to-r from-purple-600 to-pink-500 text-white py-16">
                <div className="container mx-auto text-center">
                    ...
                    <a
                        href="#"
                        className="bg-white text-pink-500 px-8 py-3 rounded-full font-semibold text-lg shadow-md hover:shadow-lg transition transform hover:scale-105 cursor-not-allowed opacity-50"
                    >
                        Coming Soon
                    </a>
                </div>
