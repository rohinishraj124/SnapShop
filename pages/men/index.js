...
const Men = () => {
  return (
    <section className="flex flex-col justify-center items-center text-gray-600 dark:text-gray-200 body-font bg-gray-50 dark:bg-gray-900">
      ...
      <h2 className="text-3xl font-bold text-center mt-6 text-gray-900 dark:text-gray-100">Men Section</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          <Link href={'/men/tshirts'}>
            <div className="cursor-pointer shadow-lg p-4 w-full h-full rounded-lg bg-white dark:bg-gray-800">
              ...
              <div className="text-center mt-4">
                <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1 dark:text-gray-400">Men</h3>
                <h2 className="text-gray-900 title-font text-lg font-medium dark:text-gray-100">T-shirts</h2>
              </div>
            </div>
          </Link>
          ...
          <Link href={'/men/shirts'}>
            <div className="cursor-pointer shadow-lg p-4 w-full h-full rounded-lg bg-white dark:bg-gray-800">
              ...
              <div className="text-center mt-4">
                <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1 dark:text-gray-400">Men</h3>
                <h2 className="text-gray-900 title-font text-lg font-medium dark:text-gray-100">Shirts</h2>
              </div>
            </div>
          </Link>
          ...
          <Link href={'/men/jeans'}>
            <div className="cursor-pointer shadow-lg p-4 w-full h-full rounded-lg bg-white dark:bg-gray-800">
              ...
              <div className="text-center mt-4">
                <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1 dark:text-gray-400">Men</h3>
                <h2 className="text-gray-900 title-font text-lg font-medium dark:text-gray-100">Jeans</h2>
              </div>
            </div>
          </Link>
          ...
          <Link href={'/men/shorts'}>
            <div className="cursor-pointer shadow-lg p-4 w-full h-full rounded-lg bg-white dark:bg-gray-800">
              ...
              <div className="text-center mt-4">
                <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1 dark:text-gray-400">Men</h3>
                <h2 className="text-gray-900 title-font text-lg font-medium dark:text-gray-100">Shorts & Trousers</h2>
              </div>
            </div>
          </Link>
          ...
          <Link href={'/men/shoes'}>
            <div className="cursor-pointer shadow-lg p-4 w-full h-full rounded-lg bg-white dark:bg-gray-800">
              ...
              <div className="text-center mt-4">
                <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1 dark:text-gray-400">Men</h3>
                <h2 className="text-gray-900 title-font text-lg font-medium dark:text-gray-100">Shoes</h2>
              </div>
            </div>
          </Link>
          ...
          <Link href={'/men/infant'}>
            <div className="cursor-pointer shadow-lg p-4 w-full h-full rounded-lg bg-white dark:bg-gray-800">
              ...
              <div className="text-center mt-4">
                <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1 dark:text-gray-400">Men</h3>
                <h2 className="text-gray-900 title-font text-lg font-medium dark:text-gray-100">Infant Necessities</h2>
              </div>
            </div>
          </Link>
        </div>
