...
const shirts = () => {
  const products = Array(8).fill({
    ...
    title: 'The Catalyzer',
    price: '₹399',
    image: 'https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcQgHhByJHFj5WEl70x6A9szuqPfKjGoU4txq04SywTzH8WtarUsArYaKn3XAcpV5eCpVcnupCxyHgdjLgm9jTP99OTpdxvcTcojjefKSwmOsDPIFXUc5zlj&usqp=CAE',
